...
while True:
    ...
    context.load_cert_chain(certfile="M:/NguyenKhacMinhHieu-2280607474/lab-05/ssl/certificates/server-cert.crt", keyfile="M:/NguyenKhacMinhHieu-2280607474/lab-05/ssl/certificates/server-key.key")
